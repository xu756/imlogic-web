        ...
        <div className="w-full">
            <div className="flex justify-start mb-4">
                <img
                    ...
                    alt=""
                />
                <div className="ml-2 max-w-lg py-3 px-4 bg-white rounded-br-3xl rounded-tr-2xl rounded-tl-xl">
            ...
            <div className="flex flex-col mt-5">
                <div className="flex justify-end mb-4">
                    <div className="max-w-lg mr-2 py-3 px-4 bg-indigo-500 rounded-bl-3xl rounded-tl-3xl rounded-tr-xl">
